...
import { TASK_KEYS, TASK_LABELS, formatDate, isOverdue, typeColorClass } from "@/lib/projectUtils";
      ...
      <div className="p-5 space-y-4 flex-1">
        ...
        <div className="space-y-2 pt-2 border-t">
          {TASK_KEYS.map((key) => {
            ...
            if (!t) return null;
            const disabled = t.is_done || !canCheck;
            return (
              <div key={key} className="flex items-start gap-3 text-sm">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {t.is_done && t.done_at && (
                    <div className="text-xs text-success mt-0.5">✓ Terminé le {formatDate(t.done_at)}</div>
                  )}
                </div>
